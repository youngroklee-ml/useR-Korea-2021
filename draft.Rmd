...
```{r package-folder-structure, out.width='70%'}
knitr::include_graphics("images/package-folder-structure.png")
```
...
```{r data-folder-files, out.width='50%'}
...
```{r recipe, fig.alt='https://www.10000recipe.com/recipe/6839413', out.width='100%'}
